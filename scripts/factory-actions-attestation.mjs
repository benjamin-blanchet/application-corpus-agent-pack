...
import { SHA_PATTERN, parseArgs, printResult } from './lib/factory-delivery/core.mjs';
...
export function verifyActionsArtifactObservation({ repository, runId, candidateSha, workflowSha, workflowRef, artifactName, runRecord, artifactResponse }) {
