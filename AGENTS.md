...
CLI — and adopted from intent when no agent was selected. Routing, the
read-only roles for non-developers, and the re-anchoring footer:
[doc/_agents/copilot-surfaces.md](doc/_agents/copilot-surfaces.md).
