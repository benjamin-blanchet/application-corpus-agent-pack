...
An implementation lot never owns the artefacts that authorise or attest its
own work: the specification, this TIP, `factory/plan.v3.json`, the event log,
derived state, work journal, acceptance results/evidence, corpus closeout, or
draft-PR contract. Functional Analyst, Planner, Controller, Acceptance,
Corpus and Delivery keep those write surfaces outside implementation claims.
