...
```bash
npx github:benjamin-blanchet/application-corpus-agent-pack#v1.3.0 sync --profile core
```
...
```bash
npx github:benjamin-blanchet/application-corpus-agent-pack#v1.3.0 sync --profile core --apply
```
...
```bash
npx github:benjamin-blanchet/application-corpus-agent-pack#v1.3.0 sync --profile sources --apply
npx github:benjamin-blanchet/application-corpus-agent-pack#v1.3.0 sync --profile factory --apply
```
...
- Pin releases (`#v1.3.0`) for reproducible installation.
