...
description: "Navigate the canonical doc/ structure, read CORPUS_MAP before searching broadly, use doc/_indexes for cross-cutting lookup, and prefer canonical files over duplicated summaries."
---
# Corpus Navigation

## Purpose

Navigate the canonical doc/ structure, read CORPUS_MAP before searching broadly, use doc/_indexes for cross-cutting lookup, and prefer canonical files over duplicated summaries.
