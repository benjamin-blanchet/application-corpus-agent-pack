---
name: scope-deepening
category: authoring
description: "Deepen a feature or spec by adding missing flows, rules, operations, risks, tests and agent guidance from verified sources."
---
# Scope Deepening

## Purpose

Deepen a feature or spec by adding missing flows, rules, operations, risks, tests and agent guidance from verified sources.
