...
category: authoring
description: "Write Jira-ready stories, tasks or bugs from corpus-grounded facts, with clear scope, acceptance criteria, impacts and links."
---
# Jira Ticket Writing

## Purpose

Write Jira-ready stories, tasks or bugs from corpus-grounded facts, with clear scope, acceptance criteria, impacts and links.
