...
category: authoring
description: "Produce incident analysis and atomic prod knowledge updates from logs, metrics, traces, tickets and code evidence."
---
# Analyze Incident

## Purpose

Produce incident analysis and atomic prod knowledge updates from logs, metrics, traces, tickets and code evidence.
