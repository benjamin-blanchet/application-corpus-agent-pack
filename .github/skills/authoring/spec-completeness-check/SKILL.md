...
category: authoring
description: "Check that a spec has need, scope, impacts, tests, assumptions, open questions and links to relevant corpus files."
---
# Spec Completeness Check

## Purpose

Check that a spec has need, scope, impacts, tests, assumptions, open questions and links to relevant corpus files.
