...
category: authoring
description: "Track meaningful corpus changes using frontmatter, doc/_meta/generation-log.md and, only for major corpus-level changes, doc/_meta/corpus-changelog.md."
---
# Modification Tracking

## Purpose

Track meaningful corpus changes using frontmatter, doc/_meta/generation-log.md and, only for major corpus-level changes, doc/_meta/corpus-changelog.md.
