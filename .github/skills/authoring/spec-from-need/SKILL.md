...
name: spec-from-need
category: authoring
description: "Turn a raw need into a spec package grounded in corpus facts and explicit assumptions."
---
# Spec From Need

## Purpose

Turn a raw need into a spec package grounded in corpus facts and explicit assumptions.
