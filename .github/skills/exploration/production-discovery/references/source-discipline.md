...
- For Dynatrace MCP, run `sources/mcp-readiness-check` first. Do not mark Dynatrace unavailable until server/tool attachment has been checked in the IDE context.
